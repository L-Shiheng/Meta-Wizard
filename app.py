    ...
    with sub_tab1:
        ...
        if matrix == "血清/血浆 (Serum/Plasma)":
            if method_source == "Zhulab 推荐常规流程":
                ...
                **Zhulab 标准血清/血浆提取步骤：**
                1. 将血清/血浆样本在 4 ℃ 缓慢解冻。
                2. 吸取 **100 μL** 样本至 1.5 mL EP 管中。
                3. 加入 **400 μL** 预冷的甲醇/乙腈（1:1, v/v）提取液（此步可加入内标）。
                4. 涡旋混匀 **30 秒**，置于冰水浴中超声 **10 分钟**。
                5. 转移至 -20 ℃ 冰箱中静置孵育 **1 小时**，以彻底沉淀蛋白。
                6. 在 4 ℃ 环境下，以 **14000 g** 高速离心 **15 分钟**。
                7. 小心吸取上清液转移至新管中，使用真空离心浓缩仪干燥。
                8. 将干燥后的样品在-80摄氏度下长期保存。
                9. 上机前，加入 **100 μL** 乙腈/水（1:1, v/v）重新溶解干燥后的样品。
                10. 涡旋30秒，在4摄氏度的水浴中超声10分钟。
                11. 在4摄氏度下以13000转/分钟的速度离心15分钟。
                12. 将上清液转移到液相色谱样品瓶中，并在4摄氏度下保存，用于液相色谱-质谱分析。
                """)
            else:
